...
final class AnvilInventoryV1_20_4 extends AnvilMenu implements AnvilInventory {
    ...
    AnvilInventoryV1_20_4(final Player player, final Component title) {
        this(((CraftPlayer) player).getHandle(), title);
    }

    AnvilInventoryV1_20_4(
        ...
        final CraftInventoryAnvil inventory =
            new CraftInventoryAnvil(access.getLocation(), inputSlots, resultSlots, this);
    ...
    public void renameText(final String renameText) {
        ...
        result = result.copy();
        result.setHoverName(net.minecraft.network.chat.Component.literal(renameText));
